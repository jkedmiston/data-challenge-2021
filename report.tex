...
\begin{figure}[ht]
\centering
\subfloat[Performance curves for Logisic Regression Classifier and the operating point at decision threshold 0.39 is highlighted. ]{\label{fig:performance}\includegraphics[height=6cm]{performance.png}}\hfill
\subfloat[ROC curve for Logistic Regression Classifier, and the operating point at decision threshold 0.39 is highlighted.]{\label{fig:roc}\includegraphics[height=6cm]{ROC.png}}\\
...
\subfloat[Logistic regression classifier operating at decision threshold 0.39]{\label{fig:tuned}\includegraphics[height=6cm]{cm_tuned.png}}\\
